...
-   Two sessions:
    ...
    -   Friday, October 10th, 9:30am - 12:30pm

-   Course website:

    -   <https://github.com/aaslinur/intro-to-R>
...
-   **Instructor**
    ...
    -   **Aasli Abdi Nur**
        ...
        -   Postdoctoral Research Fellow, Computational Demography
        
        -   Dept. of Sociology, Leverhulme Centre for Demographic Science, Nuffield College
        
        -   Contact: <aasli.nur@sociology.ox.ac.uk>

. . .

-   **Teaching Assistants**

    -   **Laura Leone**, DPhil Student
    -   **Jordan Rothschild**, DPhil Student 
    -   **Bill Wetzel**, DPhil Student
...
-   **Overview**
    ...
    -   Describe why `R` is a powerful tool for social science research

. . .

-   **Installation**

    -   Successfully install `R` and `R Studio`

. . .

-   **Application**

    -   Introduce `R` syntax, data types, and data structures
    
    -   Develop a basic understanding of data manipulation and visualisation
...
-   Exploring the benefits of `R` and `R Studio`
...
-   `RStudio` is an integrated development environment (IDE) for `R` programming
    ...
    -   Download: [https://posit.co/downloads/](https://posit.co/downloads/)
    

## Exploring the benefits of `R`?

-   **Cost**: free and open source - you don't need a terminal server or license.

. . .

-   **Flexibility**: can handle virtually any data format.

. . .

-   **Functionality**: powerful language for data manipulation, statistical analysis, and publication-ready data visualizations

. . .

-   **Reproducibility**: makes replication easy.

. . .

-   **Resources**: large community for support and learning.


## Easy to simulate and plot data {.smaller}
...
knitr::include_graphics(here("Slides/Session1_Slides_files/figs/rstudio.png"))
```
...
-   **`R` Notebooks (Quarto, `R` Notebook, `R` Markdown)**
...
knitr::include_graphics(here("Slides/Session1_Slides_files/figs/quarto.png"))
```
:::
::::::
...
print("Thank you for attending the first session!")
```
...
-   Questions: [aasli.nur@sociology.ox.ac.uk](aasli.nur@sociology@sociology.ox.ac.uk)
